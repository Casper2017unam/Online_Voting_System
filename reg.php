        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Please sign up<small> school representative council voting!</small></h3>
			 			</div>
			 			<div class="panel-body">
			    			...
			    			<input type="student_id" name="student_id"  placeholder="Student Number">
			    			</div>
